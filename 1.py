...
with Image.open('1-17879_image-information-nature-high-quality-background-hd-png.png') as pic_original:
    ...
    imp_gray_smooth = pic_original.filter(ImageFilter.SMOOTH)
    imp_gray_smooth = imp_gray_smooth.filter(ImageFilter.FIND_EDGES)
    imp_gray_smooth.save('imp_gray_smooth.jpg')
    imp_gray_smooth.show()
